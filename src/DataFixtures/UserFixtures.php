...
class UserFixtures extends Fixture
{
    public function load(ObjectManager $manager)
    {
        ...
        Issu du monde du travail et de l’entreprise, ayant évolué dans le secteur public et privé, 
        j’ai évolué sur des fonctions managériales en ressources humaines.
        ...
        et problématiques que vous avez vécues.
